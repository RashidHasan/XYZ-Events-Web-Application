...
<body>
    ...
    <main>
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                    <ul class="navbar-nav align-items-lg-center ms-auto me-lg-5">
                        ...
                        <li class="nav-item">
                            <a class="nav-link click-scroll" href="bookTheEventPage.php">Book The Event</a>
                        </li>
            ...
            <div class="container d-flex justify-content-center align-items-center">
                ...
                <div class="row">
                    <div class="col-12 mt-auto mb-5 text-center">
                        ...
                        <a style="margin-top: 20px;" href="bookTheEventPage.php"> <button class="buttonSp">
                                Booking Now!
                            </button></a>
        ...
        <section class="pricing-section section-padding section-bg" id="">
            <div class="container">
                <div class="row">
            ...
            <div class="row">
                ...
                <div class="col-lg-6 col-12 mb-4 pb-2">
                    ...
                    <ul class="site-footer-links">
                        ...
                        <li class="site-footer-link-item">
                            <a href="bookTheEventPage.php" class="site-footer-link">Book Event</a>
                        </li>
